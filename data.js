...
window.LC_MODIFIERS_BY_LAMP = {
  ...
  aputure_600d: [
    ...
    { id: "dome150_bare",   label: "Light Dome 150 — bare",           factor: 1.0   },
    { id: "dome150_15",     label: "Light Dome 150 — 1.5-Stop",       factor: 0.354 },
    { id: "dome150_25",     label: "Light Dome 150 — 2.5-Stop",       factor: 0.177 },
    { id: "dome2_bare",     label: "Light Dome II — bare",            factor: 1.0   },
    { id: "dome2_15",       label: "Light Dome II — 1.5-Stop",        factor: 0.354 },
    { id: "dome2_25",       label: "Light Dome II — 2.5-Stop",        factor: 0.177 },
    { id: "lantern",        label: "Lantern",                         factor: 0.18  },
    { id: "spotlight_19",   label: "Spotlight Mount 19°",        factor: 5.0   },
    { id: "spotlight_26",   label: "Spotlight Mount 26°",        factor: 4.1   },
    { id: "spotlight_36",   label: "Spotlight Mount 36°",        factor: 2.8   },
  ],
  aputure_300d2: [
    { id: "bare",           label: "Bare Bulb",                       factor: 1.0   },
  ...
  nanlux_2400b: [
    ...
    { id: "nl70",        label: "NL70 Parallel Beam",              factor: 26.0  },
  ],
  godox_sl200ii: [
    { id: "bare",      label: "Bare Bulb",          factor: 1.0  },
  ...
  custom: [
    { id: "bare",       label: "Bare Bulb",              factor: 1.0   },
    { id: "reflector",  label: "Reflektor",               factor: 1.6   },
    { id: "softbox",    label: "Softbox",                 factor: 0.55  },
    { id: "dome_bare",  label: "Dome / Octobox — bare",   factor: 1.0   },
    { id: "dome_15",    label: "Dome / Octobox — 1.5-Stop", factor: 0.354 },
    { id: "dome_25",    label: "Dome / Octobox — 2.5-Stop", factor: 0.177 },
    { id: "fresnel",    label: "Fresnel",                 factor: 3.0   },
    { id: "lantern",    label: "Lantern",                 factor: 0.18  },
  ],
};
